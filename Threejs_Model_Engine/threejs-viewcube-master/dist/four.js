...
FOUR.Viewcube = (function () {
    ...
    Viewcube.prototype.setupGeometry = function () {
        ...
        var material1 = new THREE.MeshPhongMaterial({
            color: 0xAAAAAA,
            map: new THREE.TextureLoader().load('lib/img/top.png'),
            opacity: 1.0,
            transparent: true
        });
        var material2 = new THREE.MeshPhongMaterial({
            color: 0xAAAAAA,
            map: new THREE.TextureLoader().load('lib/img/front.png'),
            opacity: 1.0,
            transparent: true
        });
        var material3 = new THREE.MeshPhongMaterial({
            color: 0xAAAAAA,
            map: new THREE.TextureLoader().load('lib/img/right.png'),
            opacity: 1.0,
            transparent: true
        });
        var material4 = new THREE.MeshPhongMaterial({
            color: 0xAAAAAA,
            map: new THREE.TextureLoader().load('lib/img/back.png'),
            opacity: 1.0,
            transparent: true
        });
        var material5 = new THREE.MeshPhongMaterial({
            color: 0xAAAAAA,
            map: new THREE.TextureLoader().load('lib/img/left.png'),
            opacity: 1.0,
            transparent: true
        });
        var material6 = new THREE.MeshPhongMaterial({
            color: 0xAAAAAA,
            map: new THREE.TextureLoader().load('lib/img/bottom.png'),
            opacity: 1.0,
            transparent: true
        });
        var materials = [
