(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) :
		...
		class TzExtrudeGeometry extends TzGeometry {
			...
			get mesh() {
				const [depth, rotate, axisX, axisY, axisZ] = this.transform;
				// const axis = new Vector3(axisX, axisZ, axisY);
				const axis = new Vector3(axisX, axisZ, axisY);//.applyMatrix4(this.matrix);
