...
namespace World
{
    public static class MapGenerator
    {
        ...
        public static World.Map mapBeingGenerated;
        ...
        public static Map GenerateMap(Vector3Int size)
        {

            Map map = new Map();

          //  int seed = SeedGenerator.HashCombineInt();



        }

        public static World.Map GenerateMap(IntVec3 mapSize, MapParent parent, MapGeneratorDef mapGenerator, IEnumerable<GenStepWithParams> extraGenStepDefs = null, Action<World.Map> extraInitBeforeContentGen = null)
        {
        ...
        public static void GenerateContentsIntoMap(IEnumerable<GenStepWithParams> genStepDefs, World.Map map, int seed)
        {
            MapGenerator.data.Clear();
            Rand.PushState();
            try
