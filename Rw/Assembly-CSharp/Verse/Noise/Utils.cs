...
namespace Verse.Noise
{
	...
	internal static class Utils
	{
		...
		internal static double GradientCoherentNoise3D(double x, double y, double z, long seed, QualityMode quality)
		{
			...
			double a3 = Utils.GradientNoise3D(x, y, z, num, iy, num3, seed);
			b = Utils.GradientNoise3D(x, y, z, ix, iy, num3, seed);
			double b2 = Utils.InterpolateLinear(a3, b, position);
			double a4 = Utils.InterpolateLinear(a2, b2, position2);
			double a5 = Utils.GradientNoise3D(x, y, z, num, num2, iz, seed);
			b = Utils.GradientNoise3D(x, y, z, ix, num2, iz, seed);
			double a6 = Utils.InterpolateLinear(a5, b, position);
			double a7 = Utils.GradientNoise3D(x, y, z, num, iy, iz, seed);
			b = Utils.GradientNoise3D(x, y, z, ix, iy, iz, seed);
			b2 = Utils.InterpolateLinear(a7, b, position);
			double b3 = Utils.InterpolateLinear(a6, b2, position2);
