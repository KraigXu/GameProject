...
namespace RimWorld.BaseGen
{
	...
	{
		// Token: 0x06006586 RID: 25990 RVA: 0x00238338 File Offset: 0x00236538
		public override void Resolve(ResolveParams rp)
		{
			SymbolResolver_Settlement.<>c__DisplayClass1_0 <>c__DisplayClass1_ = new SymbolResolver_Settlement.<>c__DisplayClass1_0();
			<>c__DisplayClass1_.map = BaseGen.globalSettings.map;
			...
			Lord singlePawnLord = rp.singlePawnLord ?? LordMaker.MakeNewLord(faction, new LordJob_DefendBase(faction, rp.rect.CenterCell), <>c__DisplayClass1_.map, null);
			...
			resolveParams.singlePawnSpawnCellExtraPredicate = (rp.singlePawnSpawnCellExtraPredicate ?? ((IntVec3 x) => <>c__DisplayClass1_.map.reachability.CanReachMapEdge(x, traverseParms)));
			if (resolveParams.pawnGroupMakerParams == null)
			{
				resolveParams.pawnGroupMakerParams = new PawnGroupMakerParms();
				resolveParams.pawnGroupMakerParams.tile = <>c__DisplayClass1_.map.Tile;
