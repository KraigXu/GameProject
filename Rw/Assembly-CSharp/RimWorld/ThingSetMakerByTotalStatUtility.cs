...
namespace RimWorld
{
	...
	public static class ThingSetMakerByTotalStatUtility
	{
		...
		public static List<ThingStuffPairWithQuality> GenerateDefsWithPossibleTotalValue_NewTmp3(IntRange countRange, float totalValue, IEnumerable<ThingDef> allowed, TechLevel techLevel, QualityGenerator qualityGenerator, Func<ThingStuffPairWithQuality, float> getMinValue, Func<ThingStuffPairWithQuality, float> getMaxValue, Func<ThingStuffPairWithQuality, float> getSingleThingValue, Func<ThingDef, float> weightSelector = null, int tries = 100, float maxMass = 3.40282347E+38f, bool allowNonStackableDuplicates = true, float minSingleItemValue = 0f)
		{
			...
			int num = 0;
			Func<ThingStuffPairWithQuality, bool> <>9__1;
			Func<ThingStuffPairWithQuality, bool> <>9__4;
			for (;;)
			{
				num++;
				if (num > 10000)
				...
				Func<ThingStuffPairWithQuality, bool> predicate;
				if ((predicate = <>9__1) == null)
				{
					predicate = (<>9__1 = delegate(ThingStuffPairWithQuality x)
					{
				...
				if (countRange.max != 2147483647 && totalMaxValueSoFar < totalValue * 0.5f)
				{
					...
					Func<ThingStuffPairWithQuality, bool> predicate2;
					if ((predicate2 = <>9__4) == null)
					{
						predicate2 = (<>9__4 = ((ThingStuffPairWithQuality x) => totalMaxValueSoFar + maxCandidateValueEver * (float)(countRange.max - chosen.Count - 1) + getMaxValue(x) >= totalValue * 0.5f));
					}
		...
		// Token: 0x06004FBB RID: 20411 RVA: 0x001AE654 File Offset: 0x001AC854
		...
		// Token: 0x06004FBC RID: 20412 RVA: 0x001AE748 File Offset: 0x001AC948
		...
		// Token: 0x06004FBD RID: 20413 RVA: 0x001AE790 File Offset: 0x001AC990
		...
		// Token: 0x06004FBE RID: 20414 RVA: 0x001AE7CC File Offset: 0x001AC9CC
