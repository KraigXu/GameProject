		...
		private static void DoDebugOptions(Rect rightRect, Pawn pawn)
		{
			...
			if (Widgets.ButtonText(new Rect(rightRect.x + 240f, rightRect.y - 27f, 115f, 25f), "Debug info"))
			{
				...
				list.Add(new FloatMenuOption("IsSolid", delegate
				{
					...
					{
						stringBuilder9.AppendLine(notMissingPart.LabelCap + " " + notMissingPart.def.IsSolid(notMissingPart, pawn.health.hediffSet.hediffs).ToString());
					}
				...
				list.Add(new FloatMenuOption("IsSkinCovered", delegate
				{
					...
					{
						stringBuilder8.AppendLine(notMissingPart2.LabelCap + " " + notMissingPart2.def.IsSkinCovered(notMissingPart2, pawn.health.hediffSet).ToString());
					}
				...
				list.Add(new FloatMenuOption("Immunities", delegate
				{
					...
					foreach (HediffDef item5 in DefDatabase<HediffDef>.AllDefsListForReading)
					{
						...
						{
							stringBuilder7.AppendLine("Hediff: " + immunityRecord.hediffDef + ", Source: " + immunityRecord.source + ", Immunity: " + immunityRecord.immunity);
						}
					}
