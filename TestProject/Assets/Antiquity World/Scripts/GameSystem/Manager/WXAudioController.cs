    ...
    public class WXAudioController : MonoBehaviour
    {
        ...
        public void VulcanShot(Vector3 pos)
        {
            ...
            if (timer_01 >= vulcanDelay)
            {
                ...
                AudioSource aSrc =
                    WXPoolManager.Pools["GeneratedPool"].SpawnAudio(audioSource, vulcanShot, pos, null)
        ...
        public void VulcanHit(Vector3 pos)
        {
            if (timer_02 >= vulcanHitDelay)
            {
                ...
                AudioSource aSrc =
                    WXPoolManager.Pools["GeneratedPool"].SpawnAudio(audioSource,
        ...
        public void SoloGunShot(Vector3 pos)
        {
            ...
            {
                AudioSource aSrc =
                    WXPoolManager.Pools["GeneratedPool"].SpawnAudio(audioSource, soloGunShot, pos, null)
                        .gameObject.GetComponent<AudioSource>();
        ...
        public void SniperShot(Vector3 pos)
        {
            ...
            {
                AudioSource aSrc =
                    WXPoolManager.Pools["GeneratedPool"].SpawnAudio(audioSource, sniperShot, pos, null)
                        .gameObject.GetComponent<AudioSource>();
        ...
        public void ShotGunShot(Vector3 pos)
        {
            ...
            {
                AudioSource aSrc =
                    WXPoolManager.Pools["GeneratedPool"].SpawnAudio(audioSource, shotGunShot, pos, null)
                        .gameObject.GetComponent<AudioSource>();
        ...
        public void SeekerShot(Vector3 pos)
        {
            ...
            {
                AudioSource aSrc =
                    WXPoolManager.Pools["GeneratedPool"].SpawnAudio(audioSource, seekerShot, pos, null)
                        .gameObject.GetComponent<AudioSource>();
        ...
        public void RailGunShot(Vector3 pos)
        {
            ...
            {
                AudioSource aSrc =
                    WXPoolManager.Pools["GeneratedPool"].SpawnAudio(audioSource, railgunShot, pos, null)
                        .gameObject.GetComponent<AudioSource>();
        ...
        public void PlasmaGunShot(Vector3 pos)
        {
            ...
            {
                AudioSource aSrc =
                    WXPoolManager.Pools["GeneratedPool"].SpawnAudio(audioSource, plasmagunShot, pos, null)
                        .gameObject.GetComponent<AudioSource>();
        ...
        {
            AudioSource aOpen =
                WXPoolManager.Pools["GeneratedPool"].SpawnAudio(audioSource, plasmabeamOpen, pos, null)
                    .gameObject.GetComponent<AudioSource>();
            AudioSource aLoop =
                WXPoolManager.Pools["GeneratedPool"].SpawnAudio(audioSource, plasmabeamLoop, pos, loopParent)
                    .gameObject.GetComponent<AudioSource>();
        ...
        {
            AudioSource aClose =
                WXPoolManager.Pools["GeneratedPool"].SpawnAudio(audioSource, plasmabeamClose, pos, null)
                    .gameObject.GetComponent<AudioSource>();
        ...
        {
            AudioSource aOpen =
                WXPoolManager.Pools["GeneratedPool"].SpawnAudio(audioSource, plasmabeamHeavyOpen, pos, null)
                    .gameObject.GetComponent<AudioSource>();
            AudioSource aLoop =
                WXPoolManager.Pools["GeneratedPool"].SpawnAudio(audioSource, plasmabeamHeavyLoop, pos, loopParent)
                    .gameObject.GetComponent<AudioSource>();
        ...
        {
            AudioSource aClose =
                WXPoolManager.Pools["GeneratedPool"].SpawnAudio(audioSource, plasmabeamHeavyClose, pos, null)
                    .gameObject.GetComponent<AudioSource>();
        ...
        {
            AudioSource aOpen =
                WXPoolManager.Pools["GeneratedPool"].SpawnAudio(audioSource, lightningGunOpen, pos, null)
                    .gameObject.GetComponent<AudioSource>();
            AudioSource aLoop =
                WXPoolManager.Pools["GeneratedPool"].SpawnAudio(audioSource, lightningGunLoop, pos, loopParent.parent)
                    .gameObject.GetComponent<AudioSource>();
        ...
        {
            AudioSource aClose =
                WXPoolManager.Pools["GeneratedPool"].SpawnAudio(audioSource, lightningGunClose, pos, null)
                    .gameObject.GetComponent<AudioSource>();
        ...
        {
            AudioSource aOpen =
                WXPoolManager.Pools["GeneratedPool"].SpawnAudio(audioSource, flameGunOpen, pos, null)
                    .gameObject.GetComponent<AudioSource>();
            AudioSource aLoop =
                WXPoolManager.Pools["GeneratedPool"].SpawnAudio(audioSource, flameGunLoop, pos, loopParent.parent)
                    .gameObject.GetComponent<AudioSource>();
        ...
        {
            AudioSource aClose =
                WXPoolManager.Pools["GeneratedPool"].SpawnAudio(audioSource, flameGunClose, pos, null)
                    .gameObject.GetComponent<AudioSource>();
        ...
        public void LaserImpulseShot(Vector3 pos)
        {
            ...
            {
                AudioSource aSrc =
                    WXPoolManager.Pools["GeneratedPool"].SpawnAudio(audioSource, laserImpulseShot, pos, null)
                        .gameObject.GetComponent<AudioSource>();
