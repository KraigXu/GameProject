...
public class Ghost : MonoBehaviour
{
    ...
    void Start()
    {
        offsets.Add(transform.position+ newPos[0]);
        offsets.Add(transform.position+newPos[1]);
        offsets.Add(transform.position+newPos[2]);
        offsets.Add(transform.position+newPos[3]);
