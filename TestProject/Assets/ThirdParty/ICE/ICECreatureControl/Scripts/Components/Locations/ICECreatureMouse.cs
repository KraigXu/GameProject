...
namespace ICE.Creatures{
	...
	public class ICECreatureMouse : ICECreatureLocation {
		...
		public override EntityClassType EntityType{
			get{ return EntityClassType.Mouse; }
		}
		...
		public bool UseMoveOnButtonDown = false;

		public override void Update()
		{
			if( UseMoveOnButtonDown && ! Input.GetMouseButtonDown(0) )
				return;
