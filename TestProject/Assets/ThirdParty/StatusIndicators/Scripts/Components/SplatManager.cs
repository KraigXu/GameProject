...
namespace Werewolf.StatusIndicators.Components {
	...
	public class SplatManager : MonoBehaviour {
	    ...
	    /// </summary>
	    public SpellIndicator[] SpellIndicators;
		...
		/// </summary>
        public RangeIndicator[] RangeIndicators;

		/// <summary>
		/// Returns the currently selected Spell Indicator.
		/// </summary>
        public SpellIndicator CurrentSpellIndicator;

		/// <summary>
		/// Returns the currently selected Status Indicator.
		/// </summary>
        public StatusIndicator CurrentStatusIndicator;

		/// <summary>
		/// Returns the currently selected Range Indicator.
		/// </summary>
        public RangeIndicator CurrentRangeIndicator;
