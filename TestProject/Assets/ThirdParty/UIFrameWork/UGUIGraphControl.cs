...
public class UGUIGraphControl : MonoBehaviour
{
    ...
    {
        obj.GetComponent<RectTransform>().SetInsetAndSizeFromParentEdge(RectTransform.Edge.Right, DiatanceNum, WidthNum);
    }
    ...
    /// <param name="max"></param>
    /// <returns></returns>
    public static RectTransform SetRectTransformAnchoredAndOffset(GameObject go, Vector2 Anchoredpos, Vector2 min, Vector2 max)
    {
        RectTransform RT = go.GetComponent<RectTransform>();
        RT.offsetMin = min;
        RT.offsetMax = max;
    ...
    public static void SetToggleSpriteState(GameObject toggle, GameObject disabledSprite, GameObject highlightedSprite, GameObject pressedSprite)
    {
