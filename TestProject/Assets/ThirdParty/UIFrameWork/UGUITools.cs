...
public class UGUITools : MonoBehaviour
{
    ...
    static public GameObject AddUnderlineByText(GameObject parent, GameObject prefab, UIEventTriggerListener.VoidDelegate _Click)
    {
        ...
        m_TextGenerationSettings = _underline.GetGenerationSettings(new Vector2(_underline.rectTransform.rect.x, 0.0f));
    ...
    static public bool IsImageCheck(string str)
    {
        ...
        if (str == "bmp" || str == "tif" || str == "iff" || str == "cpx" || str == "dwg" || str == "eps" || str == "gif" || str == "ico" || str == "peg" || str == "pm5" || str == "jpg" || str == "png")
        {
            IsPhoto = true;//png
        }
        return IsPhoto;
