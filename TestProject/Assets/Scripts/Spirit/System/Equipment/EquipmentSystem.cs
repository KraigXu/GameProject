...
namespace GameSystem
{
    ...
    public class EquipmentSystem : ComponentSystem
    {
       ...
       // 
        ...
        public static void AddEquipment(Entity entity ,string data ,EntityManager manager)
        {
            if (string.IsNullOrEmpty(data))
            {
                manager.AddComponentData(entity, new Equipment
                {
                    HelmetId = -1,
                    ClothesId = -1,
                    BeltId = -1,
                ...
                manager.AddComponentData(entity, new EquipmentCoat
                {
                    SpriteId = 1,
                    Type = EquipType.Coat,
            ...
            else
            {
                ...
                manager.AddComponentData(entity, new EquipmentHelmet
                {
