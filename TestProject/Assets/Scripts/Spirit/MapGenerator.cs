...
namespace Spirit
{
    public static class MapGenerator
    {
        ...
        public static Spirit.Map mapBeingGenerated;
        ...
        //        }
        //        IEnumerable<GenStepWithParams> enumerable = from x in mapGenerator.genSteps select new GenStepWithParams(x, default(GenStepParams));
