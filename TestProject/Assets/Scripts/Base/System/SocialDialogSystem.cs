...
namespace GameSystem
{
    public class SocialDialogSystem : ComponentSystem
    {
        ...
        {
            InteractionElement interactionA = SystemManager.ActiveManager.GetComponentData<InteractionElement>(a);
            InteractionElement interactionB = SystemManager.ActiveManager.GetComponentData<InteractionElement>(b);
