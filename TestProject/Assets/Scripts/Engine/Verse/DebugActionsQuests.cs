	...
	public static void QuestRewardsSampled()
	{
		...
		foreach (QuestScriptDef quest in DefDatabase<QuestScriptDef>.AllDefsListForReading)
		{
			if (quest.IsRootAny)
			{
				...
				{
					Dictionary<float, int> numQuestsRating5 = new Dictionary<float, int>();
					Dictionary<float, int> numQuestsRating4 = new Dictionary<float, int>();
					...
					foreach (float num in questRewardDebugPointLevels)
					{
						...
						{
							numQuestsRating5.Add(num, 0);
							numQuestsRating4.Add(num, 0);
