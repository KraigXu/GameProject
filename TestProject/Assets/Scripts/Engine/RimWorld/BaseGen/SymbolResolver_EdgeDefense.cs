        ...
        public override void Resolve(ResolveParams rp)
        {
            ...
            if (num > 0)
            {
                ...
                for (int i = 0; i < num; i++)
                {
                    ...
                    {
                        singlePawnSpawnCellExtraPredicate = (delegate (IntVec3 x)
                        {
                    ...
                    BaseGenCore.symbolStack.Push("pawn", rp2, null);
                }
            }
            ...
            for (int j = 0; j < width; j++)
            {
                if (j % 2 == 0)
                {
                    ...
                    rp3.faction = faction;
                    rp3.rect = rect;
                    BaseGenCore.symbolStack.Push("edgeSandbags", rp3, null);
                    if (!flag)
                    {
                        break;
                    }
            ...
            for (int k = 0; k < num3; k++)
            {
                ...
                rp4.faction = faction;
                rp4.rect = rect2;
                BaseGenCore.symbolStack.Push("edgeMannedMortar", rp4, null);
            }
            ...
            for (int l = 0; l < num2; l++)
            {
                ...
                BaseGenCore.symbolStack.Push("edgeThing", rp5, null);
            }
        }
